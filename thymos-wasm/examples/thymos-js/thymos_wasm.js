...
const module0 = getCoreModule('thymos_wasm.core.wasm');
const module1 = getCoreModule('thymos_wasm.core2.wasm');
const module2 = getCoreModule('thymos_wasm.core3.wasm');
const module3 = getCoreModule('thymos_wasm.core4.wasm');
...
let gen = (function* _initGenerator () {
  ...
  function trampoline7(arg0) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:io/poll@0.2.4", function="[method]pollable.block"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, '[method]pollable.block');
    rsc0.block();
    _debugLog('[iface="wasi:io/poll@0.2.4", function="[method]pollable.block"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    endCurrentTask(0);
    _debugLog('[iface="wasi:io/poll@0.2.4", function="[method]pollable.block"][Instruction::Return]', {
  ...
  function trampoline18() {
    _debugLog('[iface="wasi:cli/stderr@0.2.4", function="get-stderr"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-stderr');
    const ret = getStderr();
    _debugLog('[iface="wasi:cli/stderr@0.2.4", function="get-stderr"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    ...
    _debugLog('[iface="wasi:cli/stderr@0.2.4", function="get-stderr"][Instruction::Return]', {
      funcName: 'get-stderr',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  function trampoline19() {
    _debugLog('[iface="wasi:cli/stdin@0.2.4", function="get-stdin"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-stdin');
    const ret = getStdin();
    _debugLog('[iface="wasi:cli/stdin@0.2.4", function="get-stdin"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    ...
    _debugLog('[iface="wasi:cli/stdin@0.2.4", function="get-stdin"][Instruction::Return]', {
      funcName: 'get-stdin',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  function trampoline20() {
    _debugLog('[iface="wasi:cli/stdout@0.2.4", function="get-stdout"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-stdout');
    const ret = getStdout();
    _debugLog('[iface="wasi:cli/stdout@0.2.4", function="get-stdout"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    if (!(ret instanceof OutputStream)) {
      throw new TypeError('Resource error: Not a valid "OutputStream" resource.');
    }
    ...
    _debugLog('[iface="wasi:cli/stdout@0.2.4", function="get-stdout"][Instruction::Return]', {
      funcName: 'get-stdout',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  function trampoline21(arg0) {
    ...
    _debugLog('[iface="wasi:cli/exit@0.2.4", function="exit"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'exit');
    exit(variant0);
    _debugLog('[iface="wasi:cli/exit@0.2.4", function="exit"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="wasi:cli/exit@0.2.4", function="exit"][Instruction::Return]', {
      funcName: 'exit',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  function trampoline22(arg0) {
    _debugLog('[iface="wasi:filesystem/preopens@0.2.4", function="get-directories"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-directories');
    const ret = getDirectories();
    _debugLog('[iface="wasi:filesystem/preopens@0.2.4", function="get-directories"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var vec3 = ret;
    ...
    for (let i = 0; i < vec3.length; i++) {
      ...
      if (!handle1) {
        const rep = tuple0_0[symbolRscRep] || ++captureCnt11;
        captureTable11.set(rep, tuple0_0);
        handle1 = rscTableCreateOwn(handleTable11, rep);
      }
    ...
    _debugLog('[iface="wasi:filesystem/preopens@0.2.4", function="get-directories"][Instruction::Return]', {
  ...
  function trampoline23(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.open-at"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.open-at"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.open-at"][Instruction::Return]', {
  ...
  function trampoline24(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.stat"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.stat"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.stat"][Instruction::Return]', {
  ...
  function trampoline25(arg0, arg1, arg2) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.read-via-stream"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.read-via-stream"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.read-via-stream"][Instruction::Return]', {
  ...
  function trampoline26(arg0, arg1, arg2) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.write-via-stream"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.write-via-stream"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.write-via-stream"][Instruction::Return]', {
  ...
  function trampoline35(arg0, arg1, arg2, arg3, arg4) {
    var handle1 = arg0;
    var rep2 = handleTable5[(handle1 << 1) + 1] & ~T_FLAG;
    var rsc0 = captureTable5.get(rep2);
    if (!rsc0) {
  ...
  function trampoline38(arg0, arg1, arg2) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]input-stream.blocking-read"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]input-stream.blocking-read"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]input-stream.blocking-read"][Instruction::Return]', {
  ...
  function trampoline39(arg0, arg1, arg2, arg3) {
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-write-and-flush"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-write-and-flush"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-write-and-flush"][Instruction::Return]', {
  ...
  function trampoline41(arg0) {
    _debugLog('[iface="wasi:cli/environment@0.2.4", function="get-environment"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-environment');
    const ret = getEnvironment();
    _debugLog('[iface="wasi:cli/environment@0.2.4", function="get-environment"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var vec3 = ret;
    var len3 = vec3.length;
    ...
    dataView(memory0).setUint32(arg0 + 4, len3, true);
    dataView(memory0).setUint32(arg0 + 0, result3, true);
    _debugLog('[iface="wasi:cli/environment@0.2.4", function="get-environment"][Instruction::Return]', {
  ...
  function trampoline42(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="filesystem-error-code"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'filesystem-error-code');
    const ret = filesystemErrorCode(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="filesystem-error-code"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="filesystem-error-code"][Instruction::Return]', {
  ...
  function trampoline43(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.append-via-stream"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.append-via-stream"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.append-via-stream"][Instruction::Return]', {
  ...
  function trampoline44(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.get-type"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.get-type"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:filesystem/types@0.2.4", function="[method]descriptor.get-type"][Instruction::Return]', {
  ...
  function trampoline45(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.check-write"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.check-write"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.check-write"][Instruction::Return]', {
  ...
  function trampoline46(arg0, arg1, arg2, arg3) {
    ...
    var len3 = arg2;
    var result3 = new Uint8Array(memory0.buffer.slice(ptr3, ptr3 + len3 * 1));
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.write"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.write"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.write"][Instruction::Return]', {
  ...
  function trampoline47(arg0, arg1) {
    ...
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-flush"] [Instruction::CallInterface] (async? sync, @ enter)');
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-flush"] [Instruction::CallInterface] (sync, @ post-call)');
    for (const rsc of curResourceBorrows) {
      rsc[symbolRscHandle] = undefined;
    }
    curResourceBorrows = [];
    ...
    _debugLog('[iface="wasi:io/streams@0.2.4", function="[method]output-stream.blocking-flush"][Instruction::Return]', {
  ...
  function trampoline48(arg0, arg1) {
    _debugLog('[iface="wasi:random/random@0.2.4", function="get-random-bytes"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'get-random-bytes');
    const ret = getRandomBytes(BigInt.asUintN(64, arg0));
    _debugLog('[iface="wasi:random/random@0.2.4", function="get-random-bytes"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var val0 = ret;
    ...
    _debugLog('[iface="wasi:random/random@0.2.4", function="get-random-bytes"][Instruction::Return]', {
  ...
  ({ exports: exports1 } = yield instantiateCore(yield module0, {
    ...
    'wasi:filesystem/types@0.2.4': {
      '[method]descriptor.open-at': exports0['1'],
      '[method]descriptor.read-via-stream': exports0['3'],
      '[method]descriptor.stat': exports0['2'],
    ...
    'wasi:http/types@0.2.4': {
      ...
      '[constructor]outgoing-request': trampoline17,
      '[constructor]request-options': trampoline5,
      '[method]fields.set': exports0['15'],
      '[method]future-incoming-response.get': exports0['14'],
      '[method]future-incoming-response.subscribe': trampoline6,
      ...
      '[method]outgoing-request.set-authority': exports0['5'],
      '[method]outgoing-request.set-method': exports0['12'],
      '[method]outgoing-request.set-path-with-query': exports0['6'],
      '[method]outgoing-request.set-scheme': exports0['13'],
      '[resource-drop]fields': trampoline15,
      '[resource-drop]future-incoming-response': trampoline13,
      '[resource-drop]incoming-body': trampoline10,
      '[resource-drop]incoming-response': trampoline12,
      '[resource-drop]outgoing-body': trampoline4,
      '[resource-drop]outgoing-request': trampoline14,
      '[resource-drop]request-options': trampoline16,
      '[static]outgoing-body.finish': exports0['11'],
    },
    'wasi:io/error@0.2.4': {
    ...
    'wasi:io/streams@0.2.4': {
      '[method]input-stream.blocking-read': exports0['16'],
    ...
    wasi_snapshot_preview1: {
      environ_get: exports0['20'],
      environ_sizes_get: exports0['21'],
      fd_write: exports0['18'],
      proc_exit: exports0['22'],
      random_get: exports0['19'],
    },
  }));
  ({ exports: exports2 } = yield instantiateCore(yield module1, {
    ...
    'wasi:filesystem/types@0.2.3': {
      ...
      '[resource-drop]descriptor': trampoline0,
      'filesystem-error-code': exports0['25'],
    },
    'wasi:io/error@0.2.3': {
      '[resource-drop]error': trampoline2,
    },
  ...
  ({ exports: exports3 } = yield instantiateCore(yield module3, {
    '': {
      ...
      '19': exports2.random_get,
      '2': trampoline24,
      '20': exports2.environ_get,
      '21': exports2.environ_sizes_get,
      '22': exports2.proc_exit,
      '23': trampoline40,
      '24': trampoline41,
      '25': trampoline42,
      '26': trampoline26,
  ...
  postReturn0 = exports1['cabi_post_thymos:agent/agent@0.1.0#create'];
  postReturn1 = exports1['cabi_post_thymos:agent/agent@0.1.0#description'];
  postReturn2 = exports1['cabi_post_thymos:agent/agent@0.1.0#state'];
  postReturn3 = exports1['cabi_post_thymos:agent/memory@0.1.0#search'];
  postReturn4 = exports1['cabi_post_thymos:agent/memory@0.1.0#get'];
  postReturn5 = exports1['cabi_post_thymos:agent/memory@0.1.0#count'];
  let agent010Create;
  
  function create(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="create"][Instruction::CallWasm] enter', {
      funcName: 'create',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010Create');
    const ret = agent010Create(ptr0, len0);
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(ret + 4, true)) {
          ...
          default: {
            throw new TypeError('invalid variant discriminant for ThymosError');
          }
        }
        variant7= {
          tag: 'err',
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="create"][Instruction::Return]', {
      funcName: 'create',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function id() {
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="id"][Instruction::CallWasm] enter', {
      funcName: 'id',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010Id');
    const ret = agent010Id();
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="id"][Instruction::Return]', {
      funcName: 'id',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let agent010Description;
  
  function description() {
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="description"][Instruction::CallWasm] enter', {
      funcName: 'description',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010Description');
    const ret = agent010Description();
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="description"][Instruction::Return]', {
      funcName: 'description',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function status() {
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="status"][Instruction::CallWasm] enter', {
      funcName: 'status',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010Status');
    const ret = agent010Status();
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        switch (dataView(memory0).getUint8(ret + 4, true)) {
          ...
          default: {
            throw new TypeError('invalid discriminant specified for AgentStatus');
          }
        }
        variant7= {
          tag: 'ok',
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="status"][Instruction::Return]', {
      funcName: 'status',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function setStatus(arg0) {
    ...
    switch (val0) {
      ...
      default: {
        ...
        throw new TypeError(`"${val0}" is not one of the cases of agent-status`);
      }
    }
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="set-status"][Instruction::CallWasm] enter', {
      funcName: 'set-status',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010SetStatus');
    const ret = agent010SetStatus(enum0);
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="set-status"][Instruction::Return]', {
      funcName: 'set-status',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function state() {
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="state"][Instruction::CallWasm] enter', {
      funcName: 'state',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'agent010State');
    const ret = agent010State();
    endCurrentTask(0);
    let variant11;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        var result3 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr3, len3));
        var ptr4 = dataView(memory0).getUint32(ret + 28, true);
        var len4 = dataView(memory0).getUint32(ret + 32, true);
        var result4 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr4, len4));
        variant11= {
          tag: 'ok',
          val: {
    ...
    _debugLog('[iface="thymos:agent/agent@0.1.0", function="state"][Instruction::Return]', {
      funcName: 'state',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let memory010Remember;
  
  function remember(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember"][Instruction::CallWasm] enter', {
      funcName: 'remember',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010Remember');
    const ret = memory010Remember(ptr0, len0);
    endCurrentTask(0);
    let variant8;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember"][Instruction::Return]', {
      funcName: 'remember',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let memory010RememberTyped;
  
  function rememberTyped(arg0, arg1) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    var val1 = arg1;
    let enum1;
    switch (val1) {
      ...
      default: {
        ...
        throw new TypeError(`"${val1}" is not one of the cases of memory-type`);
      }
    }
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember-typed"][Instruction::CallWasm] enter', {
      funcName: 'remember-typed',
      paramCount: 3,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010RememberTyped');
    const ret = memory010RememberTyped(ptr0, len0, enum1);
    endCurrentTask(0);
    let variant9;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember-typed"][Instruction::Return]', {
      funcName: 'remember-typed',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let memory010RememberWithOptions;
  
  function rememberWithOptions(arg0, arg1) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    var {memoryType: v1_0, tagsJson: v1_1, priority: v1_2 } = arg1;
    var variant3 = v1_0;
    let variant3_0;
    let variant3_1;
    if (variant3 === null || variant3=== undefined) {
      ...
      switch (val2) {
        ...
        default: {
          ...
          throw new TypeError(`"${val2}" is not one of the cases of memory-type`);
        }
      }
      variant3_0 = 1;
      variant3_1 = enum2;
    ...
    if (variant6 === null || variant6=== undefined) {
      ...
      const e = variant6;
      variant6_0 = 1;
      variant6_1 = toInt32(e);
    }
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember-with-options"][Instruction::CallWasm] enter', {
      funcName: 'remember-with-options',
      paramCount: 9,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010RememberWithOptions');
    const ret = memory010RememberWithOptions(ptr0, len0, variant3_0, variant3_1, variant5_0, variant5_1, variant5_2, variant6_0, variant6_1);
    endCurrentTask(0);
    let variant14;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(ret + 4, true)) {
          ...
          case 4: {
            var ptr12 = dataView(memory0).getUint32(ret + 8, true);
            var len12 = dataView(memory0).getUint32(ret + 12, true);
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="remember-with-options"][Instruction::Return]', {
      funcName: 'remember-with-options',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function search(arg0, arg1) {
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="search"][Instruction::CallWasm] enter', {
      funcName: 'search',
      paramCount: 5,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010Search');
    const ret = memory010Search(ptr0, len0, variant3_0, variant3_1, variant3_2);
    endCurrentTask(0);
    let variant17;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        for (let i = 0; i < len10; i++) {
          ...
          switch (dataView(memory0).getUint8(base + 32, true)) {
            ...
            case 1: {
              var ptr8 = dataView(memory0).getUint32(base + 36, true);
              var len8 = dataView(memory0).getUint32(base + 40, true);
              var result8 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr8, len8));
              variant9 = result8;
              break;
            }
          ...
          result10.push({
            id: result4,
            content: result5,
            propertiesJson: result6,
            createdAt: result7,
            lastAccessed: variant9,
          });
        }
        variant17= {
          tag: 'ok',
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(ret + 4, true)) {
          ...
          case 2: {
            var ptr13 = dataView(memory0).getUint32(ret + 8, true);
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="search"][Instruction::Return]', {
      funcName: 'search',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function get(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="get"][Instruction::CallWasm] enter', {
      funcName: 'get',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010Get');
    const ret = memory010Get(ptr0, len0);
    endCurrentTask(0);
    let variant14;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        switch (dataView(memory0).getUint8(ret + 4, true)) {
          ...
          case 1: {
            ...
            switch (dataView(memory0).getUint8(ret + 40, true)) {
              ...
              case 1: {
                var ptr5 = dataView(memory0).getUint32(ret + 44, true);
                var len5 = dataView(memory0).getUint32(ret + 48, true);
                var result5 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr5, len5));
                variant6 = result5;
                break;
              }
            ...
            variant7 = {
              id: result1,
              content: result2,
              propertiesJson: result3,
              createdAt: result4,
              lastAccessed: variant6,
            };
            break;
          }
          default: {
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="get"][Instruction::Return]', {
      funcName: 'get',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function _delete(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="delete"][Instruction::CallWasm] enter', {
      funcName: 'delete',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010Delete');
    const ret = memory010Delete(ptr0, len0);
    endCurrentTask(0);
    let variant8;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="delete"][Instruction::Return]', {
      funcName: 'delete',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function count() {
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="count"][Instruction::CallWasm] enter', {
      funcName: 'count',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'memory010Count');
    const ret = memory010Count();
    endCurrentTask(0);
    let variant6;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(ret + 8, true)) {
          case 0: {
            var ptr0 = dataView(memory0).getUint32(ret + 12, true);
            var len0 = dataView(memory0).getUint32(ret + 16, true);
            var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
            variant5= {
              tag: 'configuration',
              val: result0
    ...
    _debugLog('[iface="thymos:agent/memory@0.1.0", function="count"][Instruction::Return]', {
      funcName: 'count',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function connect(arg0, arg1) {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="connect"][Instruction::CallWasm] enter', {
      funcName: 'connect',
      paramCount: 5,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Connect');
    const ret = storage010Connect(ptr0, len0, variant2_0, variant2_1, variant2_2);
    endCurrentTask(0);
    let variant9;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="connect"][Instruction::Return]', {
      funcName: 'connect',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let storage010Disconnect;
  
  function disconnect() {
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="disconnect"][Instruction::CallWasm] enter', {
      funcName: 'disconnect',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Disconnect');
    const ret = storage010Disconnect();
    endCurrentTask(0);
    let variant6;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="disconnect"][Instruction::Return]', {
      funcName: 'disconnect',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let storage010IsConnected;
  
  function isConnected() {
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="is-connected"][Instruction::CallWasm] enter', {
      funcName: 'is-connected',
      paramCount: 0,
      async: false,
      postReturn: false,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010IsConnected');
    const ret = storage010IsConnected();
    endCurrentTask(0);
    var bool0 = ret;
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="is-connected"][Instruction::Return]', {
      funcName: 'is-connected',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  function save(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="save"][Instruction::CallWasm] enter', {
      funcName: 'save',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Save');
    const ret = storage010Save(ptr0, len0);
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="save"][Instruction::Return]', {
      funcName: 'save',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function load(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="load"][Instruction::CallWasm] enter', {
      funcName: 'load',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Load');
    const ret = storage010Load(ptr0, len0);
    endCurrentTask(0);
    let variant7;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="load"][Instruction::Return]', {
      funcName: 'load',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let storage010Exists;
  
  function exists(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="exists"][Instruction::CallWasm] enter', {
      funcName: 'exists',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Exists');
    const ret = storage010Exists(ptr0, len0);
    endCurrentTask(0);
    let variant8;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="exists"][Instruction::Return]', {
      funcName: 'exists',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  function clear() {
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="clear"][Instruction::CallWasm] enter', {
      funcName: 'clear',
      paramCount: 0,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'storage010Clear');
    const ret = storage010Clear();
    endCurrentTask(0);
    let variant6;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="thymos:agent/storage@0.1.0", function="clear"][Instruction::Return]', {
      funcName: 'clear',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  agent010Create = exports1['thymos:agent/agent@0.1.0#create'];
  agent010Id = exports1['thymos:agent/agent@0.1.0#id'];
  agent010Description = exports1['thymos:agent/agent@0.1.0#description'];
  agent010Status = exports1['thymos:agent/agent@0.1.0#status'];
  agent010SetStatus = exports1['thymos:agent/agent@0.1.0#set-status'];
  agent010State = exports1['thymos:agent/agent@0.1.0#state'];
  memory010Remember = exports1['thymos:agent/memory@0.1.0#remember'];
  memory010RememberTyped = exports1['thymos:agent/memory@0.1.0#remember-typed'];
  memory010RememberWithOptions = exports1['thymos:agent/memory@0.1.0#remember-with-options'];
  memory010Search = exports1['thymos:agent/memory@0.1.0#search'];
  memory010Get = exports1['thymos:agent/memory@0.1.0#get'];
  memory010Delete = exports1['thymos:agent/memory@0.1.0#delete'];
  memory010Count = exports1['thymos:agent/memory@0.1.0#count'];
  storage010Connect = exports1['thymos:agent/storage@0.1.0#connect'];
  storage010Disconnect = exports1['thymos:agent/storage@0.1.0#disconnect'];
  storage010IsConnected = exports1['thymos:agent/storage@0.1.0#is-connected'];
  storage010Save = exports1['thymos:agent/storage@0.1.0#save'];
  storage010Load = exports1['thymos:agent/storage@0.1.0#load'];
  storage010Exists = exports1['thymos:agent/storage@0.1.0#exists'];
  storage010Clear = exports1['thymos:agent/storage@0.1.0#clear'];
  const agent010 = {
    create: create,
  ...
  const memory010 = {
    ...
    get: get,
    remember: remember,
    rememberTyped: rememberTyped,
    rememberWithOptions: rememberWithOptions,
    search: search,
  ...
  return { agent: agent010, memory: memory010, storage: storage010, 'thymos:agent/agent@0.1.0': agent010, 'thymos:agent/memory@0.1.0': memory010, 'thymos:agent/storage@0.1.0': storage010,  };
})();
